...
export type FirstTenUserProfilesQuery = {
  userProfileCollection: {
    edges: Array<{
      node: { firstName: string; lastName: string }
    } | null> | null
  } | null
}
...
) as unknown as TypedDocumentString<UserDetailsFragment, unknown>
export const FirstTenUserProfilesDocument = new TypedDocumentString(`
  ...
  FirstTenUserProfilesQuery,
  FirstTenUserProfilesQueryVariables
>
